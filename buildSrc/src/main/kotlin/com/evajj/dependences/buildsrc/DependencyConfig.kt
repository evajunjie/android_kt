...
object DependencyConfig {
    ...
    object Version {
        ...
        const val Rxjava = "2.2.3"                            // Rxjava
        const val RxAndroid = "2.1.0"                            // Rxjava
        const val RxBinding = "3.0.0"
        const val Swiperefreshlayout = "1.1.0"                  //下拉刷新布局
        const val CollectionBinding = "4.0.0"                  //下拉刷新布局
    ...
    object GitHub {
        ...
        const val CollectionBinding = "me.tatarka.bindingcollectionadapter2:bindingcollectionadapter:${Version.CollectionBinding}"
        const val CollectionBindingRecyclerView = "me.tatarka.bindingcollectionadapter2:bindingcollectionadapter-recyclerview:${Version.CollectionBinding}"
    ...
    object AAR{
        const val Crash = ":aar_libs:crash"
