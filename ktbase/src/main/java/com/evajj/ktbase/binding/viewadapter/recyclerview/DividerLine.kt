 ...
 * Description:
 **/
class DividerLine  @JvmOverloads constructor( var context: Context ,val mode :LineDrawMode = LineDrawMode.HORIZONTAL ,var dividerSize :Int = 1) :  ItemDecoration() {
    ...
    private fun drawVertical(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for (i in 0 until childCount) {
            ...
            val right: Int = if (dividerSize == 0) left +
    ...
    private fun drawHorizontal(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for (i in 0 until childCount) {
            ...
            val bottom: Int = if (dividerSize == 0) top + DEFAULT_DIVIDER_SIZE.dp.toInt()
